...
let createMember' xmlDoc this name args attrs expr =
    ...
    SynBinding.SynBinding(
        ...
        SynValData.SynValData(
            Some memberFlag,
            SynValInfo([], SynArgInfo(SynAttributes.Empty, false, None)) (*SynValInfo.Empty*) ,
            None
        ),
...
let createMember'' xmlDoc = createMember' xmlDoc "_"

let createMember = createMember' None "_"
